...
class RegistrationFormController extends GetxController {
  ...
  @override
  void onInit() {
    nikTextController = TextEditingController(text: "123456789123456");
    fullNameTextController = TextEditingController(text: "TEST NAME");
    dobTextController = TextEditingController(text: "01/01/1999");
    referalCodeTextController = TextEditingController(text: "89878");
