...
import 'package:doa/doa_lib/api/api.dart';
import 'package:doa/doa_lib/controller/main_controller.dart';
import 'package:doa/doa_lib/controller/registration_form_private_controller.dart';
...
class RegistrationFormOfficeBranchController extends GetxController {
  ...
  Future<void> _findSubdistrict() async {
    ...
    var getSubDistrict =
        (await Api().GET("kota?id_provinsi=$payload", useLoading: false)
  ...
  Future<void> _findOfficeBranch() async {
    ...
    var getRegency =
        (await Api().GET("kecamatan?id_kota=$payload", useLoading: false)
